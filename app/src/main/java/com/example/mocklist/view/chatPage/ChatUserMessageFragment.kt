...
class ChatUserMessageFragment : BaseFragment() {

    private var mViewObserver = ChatUserMessageViewObserver()
    ...
    override fun onCreateView(
        ...
        val binding = FragmentChatMessageBinding.inflate(inflater, container, false)
