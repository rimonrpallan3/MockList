...
import com.example.mocklist.viewobservers.chatPageViewObserver.ChatRegisterViewObserver
import org.koin.androidx.viewmodel.ext.android.sharedViewModel

class ChatRegisterFragment : BaseFragment() {

    private var mViewObserver = ChatRegisterViewObserver()
    ...
    override fun onCreateView(
        ...
        val binding = FragmentChatRegisterBinding.inflate(inflater, container, false)
