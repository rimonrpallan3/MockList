...
import com.example.mocklist.databinding.FragmentChatProfileBinding
...
import com.example.mocklist.viewobservers.chatPageViewObserver.ChatProfileViewObserver
...
class ChatProfileFragment : BaseFragment() {

    private var mViewObserver = ChatProfileViewObserver()
    ...
    override fun onCreateView(
        ...
        val binding = FragmentChatProfileBinding.inflate(inflater, container, false)
